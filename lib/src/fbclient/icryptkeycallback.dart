...
class ICryptKeyCallback extends IVersioned {
  ...
  late int Function(FbInterface self, int dataLength, Pointer<Uint8> data,
      int bufferLength, Pointer<Uint8> buffer) _callback;
  ...
  int callback(int dataLength, Pointer<Uint8> data, int bufferLength,

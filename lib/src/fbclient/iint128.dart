...
class IInt128 extends IVersioned {
  ...
  late void Function(FbInterface self, FbInterface status, Pointer<FbI128> from,
      int bufferLength, Pointer<Utf8> buffer) _toString;
  late void Function(FbInterface self, FbInterface status, int scale,
      Pointer<Utf8> from, Pointer<FbI128> to) _fromString;
  IInt128(super.self) {

...
class IDtcStart extends IDisposable {
  ...
  late void Function(
          FbInterface self, FbInterface status, FbInterface attachment)
      _addAttachment;
  late void Function(FbInterface self, FbInterface status,
      FbInterface attachment, int length, Pointer<Uint8> tpb) _addWithTpb;
  ...
  void addWithTpb(
      IStatus status, IAttachment attachment, int length, Pointer<Uint8> tpb) {

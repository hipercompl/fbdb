...
class IBatch extends IReferenceCounted {
  ...
  late void Function(FbInterface self, FbInterface status, int count,
      Pointer<Uint8> inBuffer) _add;
  late void Function(
      FbInterface self,
      FbInterface status,
      int length,
      ...
      int parLength,
      Pointer<Uint8> par) _addBlob;
  late void Function(FbInterface self, FbInterface status, int length,
      Pointer<Uint8> inBuffer) _appendBlobData;
  late void Function(FbInterface self, FbInterface status, int length,
      Pointer<Uint8> inBuffer) _addBlobStream;
  late void Function(FbInterface self, FbInterface status,
      Pointer<IscQuad> existingBlob, Pointer<IscQuad> blobId) _registerBlob;
  late FbInterface Function(
      FbInterface self, FbInterface status, FbInterface transaction) _execute;
  ...
  late void Function(FbInterface self, FbInterface status, int parLength,
      Pointer<Uint8> par) _setDefaultBpb;
    ...
    _addBlob = Pointer<
            NativeFunction<
                Void Function(
                    ...
                    Pointer<Uint8>)>>.fromAddress(vtable[idx++])
        .asFunction();
    _appendBlobData = Pointer<
            NativeFunction<
                Void Function(FbInterface, FbInterface, UnsignedInt,
                    Pointer<Uint8>)>>.fromAddress(vtable[idx++])
        .asFunction();
    _addBlobStream = Pointer<
            NativeFunction<
                Void Function(FbInterface, FbInterface, UnsignedInt,
                    Pointer<Uint8>)>>.fromAddress(vtable[idx++])
        .asFunction();
    _registerBlob = Pointer<
            NativeFunction<
                Void Function(FbInterface, FbInterface, Pointer<IscQuad>,
                    Pointer<IscQuad>)>>.fromAddress(vtable[idx++])
        .asFunction();
    _execute = Pointer<
            NativeFunction<
  ...
  void registerBlob(
      IStatus status, Pointer<IscQuad> existingBlob, Pointer<IscQuad> blobId) {

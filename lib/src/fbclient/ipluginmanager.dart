...
class IPluginManager extends IVersioned {
  ...
  late void Function(FbInterface self, int pluginType,
      Pointer<Utf8> defaultName, FbInterface plFactory) _registerPluginFactory;
  ...
  late FbInterface Function(
      ...
      FbInterface firebirdConf) _getPlugins;
  late FbInterface Function(
      FbInterface self, FbInterface status, Pointer<Utf8> filename) _getConfig;
  ...
  void registerPluginFactory(
      int pluginType, String defaultName, IPluginFactory plFactory) {

...
class IUtil extends IVersioned {
  ...
  late void Function(
      ...
      Pointer<Int64> counters) _getPerfCounters;
  late FbInterface Function(
      ...
      int dialect,
      Pointer<FbBoolean> stmtIsCreateDb) _executeCreateDatabase;
  late void Function(FbInterface self, int date, Pointer<UnsignedInt> year,
      Pointer<UnsignedInt> month, Pointer<UnsignedInt> day) _decodeDate;
  late void Function(
      FbInterface self,
      int time,
      ...
      Pointer<UnsignedInt> fractions) _decodeTime;
  late int Function(FbInterface self, int year, int month, int day) _encodeDate;
  late int Function(
          FbInterface self, int hours, int minutes, int seconds, int fractions)
      _encodeTime;
  late int Function(FbInterface self, Pointer<Utf8> buffer, int bufferSize,
      FbInterface status) _formatStatus;
  late int Function(FbInterface self) _getClientVersion;
  late FbInterface Function(FbInterface self, FbInterface status, int kind,
      Pointer<Uint8> buffer, int len) _getXpbBuilder;
  late int Function(FbInterface self, FbInterface status, FbInterface metadata,
      FbInterface callback) _setOffsets;
  ...
  late void Function(
      ...
      Pointer<Utf8> timeZoneBuffer) _decodeTimeTz;
  late void Function(
      FbInterface self,
      FbInterface status,
      ...
      Pointer<UnsignedInt> fractions,
      int timeZoneBufferLength,
      Pointer<Utf8> timeZoneBuffer) _decodeTimeStampTz;
  late void Function(
      FbInterface self,
      FbInterface status,
      Pointer<IscTimeTz> timeTz,
      ...
      int seconds,
      int fractions,
      Pointer<Utf8> timeZone) _encodeTimeTz;
  late void Function(
      FbInterface self,
      FbInterface status,
      ...
      int seconds,
      int fractions,
      Pointer<Utf8> timeZone) _encodeTimeStampTz;
  ...
  late void Function(
      ...
      Pointer<UnsignedInt> fractions,
      int timeZoneBufferLength,
      Pointer<Utf8> timeZoneBuffer) _decodeTimeTzEx;
  late void Function(
      FbInterface self,
      FbInterface status,
  ...
  void getFbVersion(
      IStatus status, IAttachment attachment, IVersionCallback callback) {
    _getFbVersion(self, status.self, attachment.self, callback.self);
    status.checkStatus();
  }

  void loadBlob(IStatus status, Pointer<IscQuad> blobId, IAttachment attachment,
      ITransaction transaction, String file, bool txt) {
    final fileUtf = file.toNativeUtf8(allocator: mem);
    try {
      _loadBlob(self, status.self, blobId, attachment.self, transaction.self,
          fileUtf, txt ? 1 : 0);
      status.checkStatus();
    } finally {
      mem.free(fileUtf);
  ...
  IAttachment executeCreateDatabase(IStatus status, String createDbStatement,
      int dialect, Pointer<FbBoolean> stmtIsCreateDb) {
    ...
    try {
      final res = _executeCreateDatabase(self, status.self, len,
          createDbStatementUtf, dialect, stmtIsCreateDb);
      status.checkStatus();
  ...
  void decodeDate(int date, Pointer<UnsignedInt> year,
      Pointer<UnsignedInt> month, Pointer<UnsignedInt> day) {
  ...
  IXpbBuilder getXpbBuilder(IStatus status, int kind,
      [Pointer<Uint8>? buffer, int len = 0]) {
    buffer ??= nullptr;
    final res =
        IXpbBuilder(_getXpbBuilder(self, status.self, kind, buffer, len));
    status.checkStatus();
    return res;
  }

  int setOffsets(
      IStatus status, IMessageMetadata metadata, IOffsetsCallback callback) {

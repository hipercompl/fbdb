...
class IBlob extends IReferenceCounted {
  ...
  late int Function(FbInterface self, FbInterface status, int bufferLength,
      Pointer<Uint8> buffer, Pointer<UnsignedInt> segmentLength) _getSegment;
  late void Function(FbInterface self, FbInterface status, int length,
      Pointer<Uint8> buffer) _putSegment;
  ...
  int getSegment(IStatus status, int bufferLength, Pointer<Uint8> buffer,
      Pointer<UnsignedInt> segmentLength) {
    final res =
        _getSegment(self, status.self, bufferLength, buffer, segmentLength);
    status.checkStatus();
    return res;
  }
